package com.bjeroken.nanobots.common.network;
 ...
 * Credits: CoolAlias
 * 
 * This class will house the
 * SimpleNetworkWrapper instance, which I will name 'dispatcher', as well as
 * give us a logical place from which to register our packets. These two things
 * could be done anywhere, however, even in your Main class, but I will be
 * adding other functionality (see below) that gives this class a bit more
 * utility.
 * 
...
public class PacketDispatcher {
   ...
   */
  private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel("Nanobots");
  ...
  public static final void registerPackets() {
    ...
    registerMessage(UpdateStatsMessage.class);
    registerMessage(UpdateWornStatsMessage.class);
    // Packets handled on SERVER
     registerMessage(PerkClickMessage.class);
    // Bidirectional packets:
     registerMessage(OpenGuiMessage.class);
    // registerMessage(PlaySoundPacket.class);
    // registerMessage(UpdatePerkMessage.class);
  }
  ...
  private static final <T extends AbstractMessage<T> & IMessageHandler<T, IMessage>> void registerMessage(Class<T> clazz) {
    ...
    // hard-coding them all, plus
    // it's one less parameter to pass.
